...
SHOTS = Path(r"C:\Users\puchu\.mavis\workspace\satpcgo-rebuild\previews-v3")
...
with sync_playwright() as p:
    ...
    for name, path in PAGES:
        ...
        page.screenshot(path=str(SHOTS / f"v3-desktop-{name}.png"), full_page=True)
        print(f"  [OK] v3-desktop-{name}.png")
        page.close()
    desktop.close()
    browser.close()
print(f"\nDone: {SHOTS}")
